...
# File directories
set in = /projects/QUIJOTE/Oliver/npcf/real_lognormal/mocks # input directory (see above for required contents)
set tmp = /scratch/gpfs/ophilcox/lognormal_$SLURM_ARRAY_TASK_ID
set ranroot = lognormal
set out = /projects/QUIJOTE/Oliver/npcf/real_lognormal
...
date
python python/generate_lognormal_real.py $mock_min $mock_max
