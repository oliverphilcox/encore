...
#SBATCH -n 16 # cpus
#SBATCH -N 1 # tasks
#SBATCH -t 0-07:59:59 # time
#SBATCH --mem-per-cpu=1GB
#SBATCH -o /home/ophilcox/out/patchy4pcfNodd_run.%a.out         # File to which STDOUT will be written (make sure the directory exists!)
#SBATCH -e /home/ophilcox/out/patchy4pcfNodd_run.%a.err         # File to which STDERR will be written
...
#SBATCH --array=1-250 # array of inputs
...
set out = /projects/QUIJOTE/Oliver/npcf/boss_4pcfNall_production # output file directory
set tmp = /scratch/gpfs/ophilcox/npcf4Nall_${sim_no} # temporary directory for intermediate file storage for this run (ideally somewhere with fast I/O)
