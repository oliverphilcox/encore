### combine_files.py (Oliver Philcox, 2020)
...
# Currently only N = 3 and N = 4 are supported.
...
for N in Ns:
    ...
    if N==4:
        ...
        print("Computing 4PCF coupling matrix")
        coupling_matrix = np.zeros((len(ell_1),len(ell_2),len(bin1)))
