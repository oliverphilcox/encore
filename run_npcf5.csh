...
#SBATCH -n 16 # cpus
#SBATCH -N 1 # tasks
#SBATCH -t 0-15:59:59 # time
#SBATCH --mem-per-cpu=1GB
#SBATCH -o /home/ophilcox/out/boss5pcfN_run.out         # File to which STDOUT will be written (make sure the directory exists!)
#SBATCH -e /home/ophilcox/out/boss5pcfN_run.err         # File to which STDERR will be written
...
set out = /projects/QUIJOTE/Oliver/npcf/boss_5pcfN_production # output file directory
set tmp = /scratch/gpfs/ophilcox/npcf5N_0 # temporary directory for intermediate file storage for this run (ideally somewhere with fast I/O)
