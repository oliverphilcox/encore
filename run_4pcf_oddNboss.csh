...
#SBATCH -n 16 # cpus
#SBATCH -N 1 # tasks
#SBATCH -t 0-22:59:59 # time
#SBATCH --mem-per-cpu=1GB
#SBATCH -o /home/ophilcox/out/boss4pcfNodd_run.%a.out         # File to which STDOUT will be written (make sure the directory exists!)
#SBATCH -e /home/ophilcox/out/boss4pcfNodd_run.%a.err         # File to which STDERR will be written
...
set tmp = /scratch/gpfs/ophilcox/bossN # temporary directory for intermediate file storage for this run (ideally somewhere with fast I/O)
...
/bin/ls -l >> $errlog
/bin/cp $errlog .
tar cfz $root.tgz $root.*.out $root.*pcf.txt $root.*2pcf_mult?.txt $errfile run_4pcf_oddNboss.csh
popd > /dev/null
