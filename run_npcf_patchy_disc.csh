...
#SBATCH -o /home/ophilcox/out/patchy4pcfSd_run.%a.out         # File to which STDOUT will be written (make sure the directory exists!)
#SBATCH -e /home/ophilcox/out/patchy4pcfSd_run.%a.err         # File to which STDERR will be written
...
set out = /projects/QUIJOTE/Oliver/npcf/boss_4pcfS_production_disc # output file directory
set tmp = /scratch/gpfs/ophilcox/npcf4S_${sim_no} # temporary directory for intermediate file storage for this run (ideally somewhere with fast I/O)
