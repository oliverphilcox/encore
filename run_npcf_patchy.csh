...
#SBATCH --array=1-50 # array of inputs
...
set out = /projects/QUIJOTE/Oliver/npcf/boss_4pcfN2_production # output file directory
...
/bin/ls -l >> $errlog
/bin/cp $errlog .
tar cfz $root.tgz $root.*.out $root.*pc*.txt $errfile run_npcf_patchy.csh
popd > /dev/null
