...
#SBATCH -o /home/ophilcox/out/boss4pcfSodd_run.%a.out         # File to which STDOUT will be written (make sure the directory exists!)
#SBATCH -e /home/ophilcox/out/boss4pcfSodd_run.%a.err         # File to which STDERR will be written
...
/bin/ls -l >> $errlog
/bin/cp $errlog .
tar cfz $root.tgz $root.*.out $root.*pcf.txt $root.*2pcf_mult?.txt $errfile run_4pcf_oddSboss.csh
popd > /dev/null
