...
#SBATCH -o /home/ophilcox/out/quijote_hr_rsd_4pcf_run.%a.out         # File to which STDOUT will be written (make sure the directory exists!)
#SBATCH -e /home/ophilcox/out/quijote_hr_rsd_4pcf_run.%a.err         # File to which STDERR will be written
...
cp run_npcf_quijote_rsd.csh $tmp
...
while ($nn <= $mock_max)
  ...
  /bin/ls -l >> $errlog
  /bin/cp $errlog .
  tar cfz $root.tgz $root.*.out $root.*pcf.txt $root.*2pcf_mult?.txt $errfile run_npcf_quijote_rsd.csh
  popd > /dev/null
