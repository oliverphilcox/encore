...
#SBATCH -o /home/ophilcox/out/boss4pcfS2_run.%a.out         # File to which STDOUT will be written (make sure the directory exists!)
#SBATCH -e /home/ophilcox/out/boss4pcfS2_run.%a.err         # File to which STDERR will be written
...
set tmp = /scratch/gpfs/ophilcox/bossS # temporary directory for intermediate file storage for this run (ideally somewhere with fast I/O)
