...
#SBATCH -o /home/ophilcox/out/paper4pcf_run.%a.out         # File to which STDOUT will be written (make sure the directory exists!)
#SBATCH -e /home/ophilcox/out/paper4pcf_run.%a.err         # File to which STDERR will be written
...
set out = /projects/QUIJOTE/Oliver/npcf/patchy_4pcf_paper # output file directory
set tmp = /scratch/gpfs/ophilcox/patchy_4pcf_${sim_no} # temporary directory for intermediate file storage for this run (ideally somewhere with fast I/O)
